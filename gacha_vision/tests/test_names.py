"""Line segmentation -- the surviving part of the name reader -- against the
real name bands of all 182 corpus cards. See gacha_vision/names.py and the
README's "Name reader" section for why reading the glyphs themselves is not
attempted here.
"""
